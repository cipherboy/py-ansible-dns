...
def create_ansible_preamble():
    return [
        "- shell: dnf install libselinux-python -y",
        ""
    ]


def create_ansible_postamble():
    return [
        "- shell: shutdown -r +1",
        "",
    ]
...
def main():
    ...
    write_lines_to_file(hosts_entry, etc_hosts_path)
